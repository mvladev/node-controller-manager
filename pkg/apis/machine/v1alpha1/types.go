...
type AzureNetworkProfile struct {
	AzureNetworkInterfaces []AzureNetworkInterfaceReference `json:"networkInterfaces,omitempty"`
}

// AzureNetworkInterfaceReference is describes a network interface reference.
type AzureNetworkInterfaceReference struct {
	ID          string 									`json:"id,omitempty"`
	Properties 	AzureNetworkInterfaceReferenceProperties 	`json:"properties,omitempty"`
}
